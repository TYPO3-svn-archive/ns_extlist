 ...
 *
 * $Id: db_list.php 7593 2010-05-13 17:12:06Z baschny $
...
class SC_db_list {
	...
	function main()	{
		...
		/**
		* @hook			SC_db_list::pageContent()
		* @date			2010-07-17
		* @request		Nuwan Sameera  <nuwan28@gmail.com>
		*/		
		if(is_array($TYPO3_CONF_VARS['SC_OPTIONS']['typo3/db_list.php']['extPageContent'])) {				
				foreach($TYPO3_CONF_VARS['SC_OPTIONS']['typo3/db_list.php']['extPageContent'] as $classData) {
						$hookObject = t3lib_div::getUserObj($classData);
						$this->body .= $hookObject->pageContent($this->table, $this);						
				}
		}
